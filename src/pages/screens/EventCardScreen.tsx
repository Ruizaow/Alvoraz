...
const EventCardScreen: React.FC<EventCardScreenProps> = ({ card, onBack }) => {
  ...
  return (
    <div className="relative w-full h-full bg-[#FFFAEA] overflow-hidden flex flex-col items-center">
      ...
      <button 
        onClick={onBack}
        className="absolute top-6 left-6 p-4 rounded-full bg-black/5 border border-black/10 text-black hover:bg-black/10 transition-all shadow-sm group z-20"
      >
        <span className={`text-4xl px-2 pb-1 group-hover:-translate-x-1 inline-block transition-transform`}>←</span>
      </button>

      {/* Main Newspaper Wrapper */}
      <div className="relative z-10 w-full max-w-6xl h-full flex flex-col px-10 md:px-20 py-8">
        ...
        <header className="w-full mb-10">
          ...
          <div className="flex justify-between items-center py-4 border-b border-black/20">
            ...
            <div className="flex-1 text-center">
              <h1 className="font-erica text-6xl md:text-7xl text-[#2E2E2E] flex items-center justify-center gap-6 whitespace-nowrap">
        ...
        {/* Content Area */}
        <div className="flex-1 flex flex-col md:flex-row gap-12 overflow-y-auto pb-20 scrollbar-hide">
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            >
              <h2 className="font-erica text-3xl md:text-4xl text-[#F7F1DE] leading-tight">
                {card.title}
              </h2>
            </div>
            ...
            {/* Subtitle if exists */}
            {card.subtitle && (
              <h3 className="font-enriqueta font-bold text-2xl md:text-3xl text-black italic">
                {card.subtitle}
              </h3>
            )}
            ...
            {/* Description */}
            <div className="py-4">
              <p className="font-enriqueta-regular text-xl md:text-2xl text-black leading-relaxed whitespace-pre-line">
                {card.description}
              </p>
            </div>
            ...
            <div className="border-t-2 border-black/20 pt-6">
              <p className="font-enriqueta font-bold text-xl md:text-2xl text-black leading-relaxed bg-black/5 p-4 border-l-8 border-black">
